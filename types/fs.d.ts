/// <reference path="./file/HandleGeneric.d.ts" />
/// <reference path="./file/WriteHandle.d.ts" />
/// <reference path="./file/BinaryWriteHandle.d.ts" />
/// <reference path="./file/BinaryReadHandle.d.ts" />
/// <reference path="./file/ReadHandle.d.ts" />
...
declare namespace fs {
  ...
  export function complete(
    ...
    location: string,
    include_files?:
      boolean | { include_dirs?: boolean; include_files?: boolean; include_hidden?: boolean },
  ...
  export function open(path: string, mode: string): WriteHandle | BinaryWriteHandle | ReadHandle | BinaryReadHandle;
